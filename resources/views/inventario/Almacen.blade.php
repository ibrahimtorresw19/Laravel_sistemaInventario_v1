...
<div class="almacenes-container">
    ...
    <div class="almacenes-header">
        ...
        <div class="controls-group">
            <a href="{{ route('Almacen.pdf') }}" class="btn btn-gray" target="_blank">
                <i class="fas fa-file-pdf btn-icon"></i>Exportar PDF
            </a>
            <button id="openModal" class="btn btn-primary">
                <i class="fas fa-plus btn-icon"></i>Nuevo Almacén
            </button>
        </div>
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr data-id="{{ $almacen->id }}">
                    ...
                    <td>
                        <span class="badge {{ $almacen->activo ? 'badge-active' : 'badge-inactive' }}">
                ...
                @empty
                <tr>
                    <td colspan="5" style="text-align: center; padding: var(--space-lg); color: #64748b;">
...
<div class="modal-overlay" id="modalOverlay">
    <div class="modal">
        <div class="modal-content">
            <h2 class="modal-title">Crear Nuevo Almacén</h2>
            <form action="{{ route('almacen.store') }}" method="POST" id="create-form">
                @csrf
                <div class="form-grid">
                    <div class="form-group">
                        <label for="nombre" class="form-label">Nombre*</label>
                        <input type="text" name="nombre" id="nombre" class="form-control" required placeholder="Nombre del almacén">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="ubicacion" id="ubicacion" class="form-control" required placeholder="Ubicación del almacén">
                        @error('ubicacion')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="capacidad" id="capacidad" class="form-control" required placeholder="Capacidad del almacén">
                        @error('capacidad')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-container">
                            <div class="toggle-switch">
                                <input type="radio" name="activo" id="activo" value="1" checked>
                                <input type="radio" name="activo" id="inactivo" value="0">
...
<div class="modal-overlay" id="modalEditOverlay">
    <div class="modal">
        <div class="modal-content">
            <h2 class="modal-title">Editar Almacén</h2>
            <form id="edit-form" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <span class="invalid-feedback" id="edit-ubicacion-error"></span>
                    </div>

                    <div class="form-group">
                        <label for="edit-capacidad" class="form-label">Capacidad*</label>
                        <input type="text" name="capacidad" id="edit-capacidad" class="form-control" required>
                        <span class="invalid-feedback" id="edit-capacidad-error"></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="toggle-container">
                            <div class="toggle-switch">
                                <input type="radio" name="activo" id="edit-activo" value="1">
                                <input type="radio" name="activo" id="edit-inactivo" value="0">
